...
URL = 'https://cd-sit.meritageweb.dev/agents'
...
class Test_Agents_Page(BasicTest):
  ...
  def test_article_1_containers(self, container):
    agents_page = AgentsPage(self.driver)
  ...
  def test_article_2_main_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_article_2_numbered_list_text(self):
    agents_page = AgentsPage(self.driver)
  ...
  # Test whether the correct text displays in each element of the numbered list in article 2
  def test_article_2_one_sublist_text(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_article_2_bottom_paragaph(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_create_account_form_on_create_account_tab_click(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_forgot_password_tab_on_sign_in_get_help_press(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
  ...
  def test_create_account_body(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_first_name_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_last_name_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_email_address_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_phone_number_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_password_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_confirm_password_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_select_metro_is_clickable(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_company_information_header(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_company_name_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_address_1_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_address_2_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_city_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_zip_input(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
    create_account_form = agents_page.get_element_create_account_form()
  ...
  def test_create_account_state_is_clickable(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_optional_form_on_register_client_click_and_optional_input_forms(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_numbered_list_text(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  # Test whether the correct text displays in each element of the numbered list in create account form
  def test_create_account_one_sublist_text(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_create_account_bottom_paragaph(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
    agents_page.click_element_create_account_button()
  ...
  def test_lets_work_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_list_div_list_elements(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_sell_your_client_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_sell_your_client_body(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_chat_articles(self, number):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
  ...
  def test_agents_rock_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_agents_rock_body(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_agents_rock_image(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_agents_rock_overlay_on_play_button(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
  ...
  def test_agents_rock_overlay_on_button(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
  ...
  def test_rock_process_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_rock_process_body(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_columns_section_containers(self, number):
    agents_page = AgentsPage(self.driver)
  ...
  def test_home_search_header(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_home_search_body(self):
    agents_page = AgentsPage(self.driver)
  ...
  def test_home_search_button_1(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()
  ...
  def test_home_search_button_2(self):
    agents_page = AgentsPage(self.driver)
    agents_page.close_cookies()

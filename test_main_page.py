...
class Test_Main_Page(BasicTest):
  ...
  def test_header_meritage_logo_translucent(self, driver_settings):
  ...
  def test_header_top_bar_navigation(self, element, driver_settings):
  ...
  def test_header_main_navigation(self, element, driver_settings):
  ...
  def test_header_level2_homes_navigation(self, state, driver_settings):
  ...
  def test_header_level2_why_meritage_navigation(self, why_meritage_nav_element, driver_settings):
  ...
  def test_header_level2_buyer_resources_navigation(self, buyer_resources_nav_element, driver_settings):
  ...
  def test_footer_company_elements(self, element, driver_settings):
  ...
  def test_footer_contact_elements(self, element, driver_settings):
    footer_tests.Test_Footer_Element_Visibility(self.driver).footer_contact_element(element)
  
  def test_optin_signup_error_image_on_wrong_email(self, driver_settings):
    footer_tests.Test_Footer_Element_Visibility(self.driver).footer_enter_email_error_image()

  def test_optin_signup_error_field_on_wrong_email(self, driver_settings):
    footer_tests.Test_Footer_Element_Visibility(self.driver).footer_enter_email_error_field()

  @pytest.mark.parametrize('element', ['1', '2', '3', '4', '5'])
  def test_footer_social_media_links(self, element, driver_settings):

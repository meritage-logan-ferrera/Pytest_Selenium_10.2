...
class BasicTest():
      ...
      match i:
        ...
        case 3:
          if 'Community' in tab_name:
            ...
            assert False
        case 4:
          if 'Find a Homesite' in tab_name:
            text_bool = True
          else:
            assert False
        case 5:
  ...
  def test_tab_homesite(self, driver_settings):
    ...
    result = self.driver.execute_script("return arguments[0].width > 0", iframe)
    assert button_clickable and result

from page_base import BasePageHeader
import pytest
import time
...
class Test_Header_Element_Visibility:
  ...
  def test_header_meritage_image_translucent(self, driver_settings):
    base_page = BasePageHeader(self.driver)
  ...
  top_bar_elements = BasePageHeader.TOP_BAR_ELEMENTS
  ...
  main_nav_elements = BasePageHeader.MAIN_NAV_ELEMENTS
  ...
  states = BasePageHeader.STATES
  @pytest.mark.parametrize('state', states)
  def test_header_level2_homes(self, state, driver_settings):
    base_page = BasePageHeader(self.driver)
    base_page.header_click_level2_element(BasePageHeader.MAIN_NAV_ELEMENTS[0], state)
    match state:
      case 'az':
  ...
  why_meritage_nav_elements = BasePageHeader.WHY_MERITAGE_NAV_ELEMENTS
  ...
  def test_header_level2_why_meritage(self, why_meritage_nav_element, driver_settings):
    base_page = BasePageHeader(self.driver)
    base_page.header_click_level2_element(BasePageHeader.MAIN_NAV_ELEMENTS[1], why_meritage_nav_element)
  ...
  buyer_resources_nav_elements = BasePageHeader.BUYER_RESOURCES_NAV_ELEMENTS
  ...
  def test_header_level2_buyer_resources(self, buyer_resources_nav_element, driver_settings):
    base_page = BasePageHeader(self.driver)
    base_page.header_click_level2_element(BasePageHeader.MAIN_NAV_ELEMENTS[2], buyer_resources_nav_element)

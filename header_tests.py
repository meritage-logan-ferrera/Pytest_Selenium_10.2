...
class Test_Header_Element_Visibility:
  ...
  top_bar_elements = BasePage.TOP_BAR_ELEMENTS
  ...
  main_nav_elements = BasePage.MAIN_NAV_ELEMENTS
  ...
  states = BasePage.STATES
  @pytest.mark.parametrize('state', states)
  def test_header_level2_homes(self, state, driver_settings):
    base_page = BasePage(self.driver)
    base_page.header_click_level2_element(BasePage.MAIN_NAV_ELEMENTS[0], state)
    match state:
      case 'az':
  ...
  why_meritage_nav_elements = BasePage.WHY_MERITAGE_NAV_ELEMENTS
  ...
  def test_header_level2_why_meritage(self, why_meritage_nav_element, driver_settings):
    base_page = BasePage(self.driver)
    base_page.header_click_level2_element(BasePage.MAIN_NAV_ELEMENTS[1], why_meritage_nav_element)
  ...
  buyer_resources_nav_elements = BasePage.BUYER_RESOURCES_NAV_ELEMENTS
  ...
  def test_header_level2_buyer_resources(self, buyer_resources_nav_element, driver_settings):
    base_page = BasePage(self.driver)
    base_page.header_click_level2_element(BasePage.MAIN_NAV_ELEMENTS[2], buyer_resources_nav_element)
